...
function NoTransitionExample() {
  return (
    <Carousel slide={false}>
      ...
      <Carousel.Item>
        <div className={s.image}>
          <img src={photocar2} width='50%' height='720px' alt="Here should be photo is trees" />
          <img src={photocar} 	width='50%' height='720px' alt="Here should be photo is trees" />
        </div>
      </Carousel.Item>
      <Carousel.Item>
        <div className={s.image}>
          <img src={photo1} width='50%' height='720px' alt="Here should be photo is trees" />
          <img src={photo2} 	width='50%' height='720px' alt="Here should be photo is trees" />
        </div>
      </Carousel.Item>
    </Carousel>
  );
