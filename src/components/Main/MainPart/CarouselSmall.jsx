  ...
  return (
    <Carousel responsive={responsive}>
      <div className="col text-center">
        <img
          className="rounded-circle me-1 border border border-secondary-subtle rounded-pill"
          width="144"
          height="144"
          src={logo_20_years}
          alt="logo_20_years"
      ...
      <div className="col text-center">
        ...
        <h4 className="fw-normal">
          Доставка от <span className="text-danger">1-го</span> кубометрa
        </h4>
      </div>
      <div className="col text-center">
        <img
      ...
      <div className="col text-center">
        <img
          ...
          width="144"
          height="144"
          src={logo_calculation}
          alt="calculation"
        />
        <h4 className="fw-normal">
          Наличный{" "}
          <HashLink to="/about-as#details" className="text-decoration-none">
            безналичный{" "}
          </HashLink>
          расчет{" "}
        </h4>
