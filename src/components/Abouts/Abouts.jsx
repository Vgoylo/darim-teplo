        ...
        <div className="d-block p-2">
          <div className="p-2 mb-4 bg-body-white rounded-3">
            <div className="container-fluid py-5">
              ...
              <p className="lead my-3 fs-3">"DARIM TEPLO" занимается поставкой дров, которые являются самым надёжным и экологическим способом для отопления.
                ...
                DARIM TEPLO доставит в любую точку Гродненсконо региона твердое топливо, которые можно применять для контроля микроклимата в отдельно стоящем доме
                ...
                Доступны большие объёмы, разные породы, стандартные размеры. Легко доставим несколько машин. Имеем колотые дрова в наличии разных пород дерева.
          ...
          <div className="row align-items-md-stretch">
            ...
            <ul className='fs-3 text-center'>
              ...
              <li className="list-group-item list-group-item-action">Р/с: BY47 BAPB 3012 2264 3001 0000 0000</li>
              <li className="list-group-item list-group-item-action">ОАО «Белагропромбанк» г. Минск, пр-т Победителей, д. 91.</li>
              <li className="list-group-item list-group-item-action">БИК: BAPBBY2X</li>
            </ul><br></br>
          </div>
        </div>
      </main >
