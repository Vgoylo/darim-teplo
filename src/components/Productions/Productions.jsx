            ...
            <div className="row row-cols-1 row-cols-sm-2 row-cols-md-2 g-2">
              <div className="col">
                <div className="card shadow-sm">
                  <img className="bd-placeholder-img card-img-top" width="100%" height="430" src='https://st9.stpulscen.ru/images/product/141/102/369_original.jpg' />
              ...
              <div className="col">
                <div className="card shadow-sm">
                  <img className="bd-placeholder-img card-img-top" width="100%" height="431" src='https://m-files.cdnvideo.ru/lpfile/f/5/2/f525e547b3723e36e31c0641b9da57e5/-/resize/600/f.jpeg' />
                  <div className="card-body">
                    <p className="card-text"><ul className="fs-4">
                      <h2>Дрова микс</h2>
              ...
              <div className="col">
                <div className="card shadow-sm">
                  <img className="bd-placeholder-img card-img-top" width="100%" height="425" src='https://m-files.cdnvideo.ru/lpfile/f/f/4/ff4294176708554557df5cf905d7b596/-/resize/600/f.jpeg' />
                  <div className="card-body">
                    <p className="card-text"><ul className="fs-4">
              ...
              <div className="col">
                <div className="card shadow">
                  <img className="bd-placeholder-img card-img-top" width="100%" height="425" src='https://m-files.cdnvideo.ru/lpfile/c/0/8/c086245363520a5cc307098eb2072607/-/resize/600/f.jpeg' />
                  <div className="card-body">
                    <p className="card-text"><ul className="fs-4">
